...
void TackyGenerator::generate_statement(const StatementAST *stmt, vector<unique_ptr<tacky::Instruction>> &instructions)
{
    ...
    else if (auto* comp = dynamic_cast<const CompoundStatementAST*>(stmt)) {
    // Convert each item inside the compound block to TACKY, in order.
...
unique_ptr<tacky::Value> TackyGenerator::generate_expression(const ExprAST *expr, vector<unique_ptr<tacky::Instruction>> &instructions)
{
    ...
    if (auto *binary_expr = dynamic_cast<const BinaryExprAST *>(expr))
    {
        ...
        case TokenType::TOKEN_OPERATOR_PLUS:
            tacky_op = tacky::BinaryOperatorType::Add;
            break;
        case TokenType::TOKEN_OPERATOR_MINUS:
            tacky_op = tacky::BinaryOperatorType::Subtract;
            break;
        case TokenType::TOKEN_OPERATOR_MULTIPLY:
            tacky_op = tacky::BinaryOperatorType::Multiply;
            break;
        case TokenType::TOKEN_OPERATOR_DIVIDE:
            tacky_op = tacky::BinaryOperatorType::Divide;
            break;
        case TokenType::TOKEN_OPERATOR_MODULO:
            tacky_op = tacky::BinaryOperatorType::Modulo;
            break;
        case TokenType::TOKEN_OPERATOR_EQUAL:
            tacky_op = tacky::BinaryOperatorType::Equal;
            break;
        case TokenType::TOKEN_OPERATOR_NOT_EQUAL:
            tacky_op = tacky::BinaryOperatorType::NotEqual;
            break;
        case TokenType::TOKEN_OPERATOR_LESS:
            tacky_op = tacky::BinaryOperatorType::LessThan;
            break;
        case TokenType::TOKEN_OPERATOR_LESS_EQUAL:
            tacky_op = tacky::BinaryOperatorType::LessOrEqual;
            break;
        case TokenType::TOKEN_OPERATOR_GREATER:
            tacky_op = tacky::BinaryOperatorType::GreaterThan;
            break;
        case TokenType::TOKEN_OPERATOR_GREATER_EQUAL:
            tacky_op = tacky::BinaryOperatorType::GreaterOrEqual;
            break;
        default:
